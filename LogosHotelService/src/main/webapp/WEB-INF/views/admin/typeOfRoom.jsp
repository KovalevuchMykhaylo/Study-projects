		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/typeOfRoom<custom:allParams/>">Type Of Room</a><span
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="typeOfRoom">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/admin/typeOfRoom/update/${typeOfRoom.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/typeOfRoom/delete/${typeOfRoom.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
