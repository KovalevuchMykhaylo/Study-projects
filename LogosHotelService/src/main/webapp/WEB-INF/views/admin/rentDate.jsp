		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/rentDate<custom:allParams/>">Rent Date</a><span
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/rentDate" method="POST" modelAttribute="rentDate">
...
<%--     						<form:input type="text" class="form-control" path="second" id="rentDate" placeholder="mm/dd/yy"/> --%>
  					...
  					<div class="form-group">
    					<div class="col-sm-offset-2 col-sm-10">
      						...
      						<a href  = "/admin/rentDate/cancel" class="btn btn-primary" >Cancel</a>
    					</div>
  					</div>
				</form:form>
			</div>
...
<%-- 					<div class="col-md-2 col-xs-2">${rentDate.roomService.hotelName}</div> --%>
					<div class="col-md-2 col-xs-2"><a class="btn btn-success" href="/admin/rentDate/update/${rentDate.id}<custom:allParams/>">update</a></div>
					<div class="col-md-2 col-xs-2"><a class="btn btn-danger" href="/admin/rentDate/delete/${rentDate.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
