			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<sec:authorize access="hasRole('ROLE_SUBADMIN') or hasRole('ROLE_ADMIN')">
						...
						<li class="active"><a href="/subuser/typeOfSubBathRoom<custom:allParams/>">Type Of Bath Room</a><span
						class="sr-only">(current)</span></li>
						<li><a href="/subuser/typeOfSubRoom">Type Of Room</a></li>
						<li><a href="/subuser/roomSubService<custom:allParams/>">Room Service</a></li>
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-inline" action="/subuser/typeOfSubBathRoom" method="GET" modelAttribute="filter">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/subuser/typeOfSubBathRoom" method="POST" modelAttribute="typeOfBathRoom">
					...
					<div class="form-group">
  					...
  					<div class="form-group">
    					<div class="col-sm-offset-2 col-sm-10">
      						...
      						<a href  = "/subuser/typeOfSubRoom/cancel" class="btn btn-primary" >Cancel</a>
    					</div>
  					</div>
				</form:form>
			</div>
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="typeOfBathRoom">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/subuser/typeOfSubBathRoom/update/${typeOfBathRoom.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/subuser/typeOfSubBathRoom/delete/${typeOfBathRoom.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
