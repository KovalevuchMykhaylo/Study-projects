		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<sec:authorize access="hasRole('ROLE_SUBADMIN') or hasRole('ROLE_ADMIN')">
						<li class="active"><a href="/subuser/aditionalSubService<custom:allParams/>">Aditional Service</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-horizontal" action="/subuser/aditionalSubService" method="GET" modelAttribute="filter">
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
					<form:checkboxes element="div" items="${hotelNames}" itemValue="id" itemLabel="name" path="hotelNameId" checked="true"/>
				</div>
			</div>
			<button type="submit" class="btn btn-primary">Ok</button>
			<a href  = "/subuser/aditionalSubService/cancel" class="btn btn-primary" >Cancel</a>
		</form:form>
	</div>
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/subuser/aditionalSubService" method="POST" modelAttribute="aditionalService">
<%-- 					<form:hidden path="hotelName" value="${aditionalService.hotelName}" style="display:none"/> --%>
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="aditionalService">
				<div class="row">
					...
					<div class="col-md-3 col-xs-3"><a class="btn btn-success" href="/subuser/aditionalSubService/update/${aditionalService.id}<custom:allParams/>">update</a></div>
					<div class="col-md-3 col-xs-3"><a class="btn btn-danger" href="/subuser/aditionalSubService/delete/${aditionalService.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
