			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<sec:authorize access="hasRole('ROLE_SUBADMIN') or hasRole('ROLE_ADMIN')">
						...
						<li class="active"><a href="/subuser/typeOfSubRoom<custom:allParams/>">Type Of Room</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-inline" action="/subuser/typeOfSubRoom" method="GET" modelAttribute="filter">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/subuser/typeOfSubRoom" method="POST" modelAttribute="typeOfRoom">
					<div class="form-group">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="typeOfRoom">
				<div class="row">
					<div class="col-md-4 col-xs-4">${typeOfRoom.type}</div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/subuser/typeOfSubRoom/update/${typeOfRoom.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/subuser/typeOfSubRoom/delete/${typeOfRoom.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
