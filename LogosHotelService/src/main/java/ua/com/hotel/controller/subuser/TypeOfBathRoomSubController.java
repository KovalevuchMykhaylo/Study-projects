...
@Controller
@RequestMapping("/subuser/typeOfSubBathRoom")
@SessionAttributes("typeOfBathRoom")
public class TypeOfBathRoomSubController {
	...
	public String delete(@PathVariable Long id, @PageableDefault Pageable pageable, @ModelAttribute("filter") SimpleFilter filter){
		...
		return "redirect:/subuser/typeOfSubBathRoom"+getParams(pageable, filter);
	}
