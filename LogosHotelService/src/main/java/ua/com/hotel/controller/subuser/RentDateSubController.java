...
@Controller
@RequestMapping("/subuser/rentSubDate")
@SessionAttributes("rentDate")
public class RentDateSubController {
...
//		model.addAttribute("hotelName", hotelNameService.findHotelNameByRentDate());
	...
	public String delete(@PathVariable Long id, @PageableDefault Pageable pageable){
		...
		return "redirect:/subuser/rentSubDate"+getParams(pageable);
	}
	@PostMapping
	...
	public String cancel(SessionStatus status){
		status.setComplete();
		return "redirect:/subuser/rentSubDate";
	}
}
