...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-inline" action="/admin/size" method="GET" modelAttribute="filter">
			...
			<a href  = "/admin/size/cancel" class="btn btn-primary" >Cancel</a>
		</form:form>
	</div>
</div>
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/size" method="POST" modelAttribute="size">
					<div class="form-group">
						<label for="size" style="color:red;text-align:left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="size"/></label>
					</div>
					<div class="form-group">
		...
		<div class="row">
			<div class="col-md-4 col-xs-4"><h3>Size mm</h3></div>
			...
			<c:forEach items="${page.content}" var="size">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/admin/size/update/${size.id}">update</a></div>
